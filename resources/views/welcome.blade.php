        ...
        <div class="col-lg-6 mt-4">
          <div class="member d-flex align-items-start" data-aos="zoom-in" data-aos-delay="300">
            ...
            <div class="member-info">
              <h4>Jawa Barat</h4>
              <h6 class="badge badge-primary">200 penghafal Quran</h6>
              <div class="progress">
                <div class="progress-bar" role="progressbar" style="width: {{100*(150/200)}}%" aria-valuenow="{{150}}"
                  aria-valuemin="0" aria-valuemax="{{200}}">
                </div>
              </div>
              <p>150 dari 200 penghafal Quran belajar di Pondok Pesantren provinsi lain</p>
              <div class="social">
                <a href=""><i class="ri-twitter-fill"></i></a>
                <a href=""><i class="ri-facebook-fill"></i></a>
                <a href=""><i class="ri-instagram-fill"></i></a>
                <a href=""> <i class="ri-linkedin-box-fill"></i> </a>
                <button class="btn btn-md btn-primary ml-auto">Detail</button>
              </div>
            </div>
          </div>
        </div>
